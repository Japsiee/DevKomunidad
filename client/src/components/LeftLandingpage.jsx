    ...
    <div className="LeftLandingpage flex justify-center items-center h-screen bg-gradient-to-r from-gray-100 to-gray-200">
      <div className="p-6 md:p-12 p-md-5">
        ...
        <div className="banner py-3">
          <a href="/" className="text-7xl font-bold text-gray-900 transition duration-200 ease-in hover:text-purple-800">Devs</a>
          <p className="text-4xl font-bold text-gray-900">Komunidad</p>
        </div>
        <p className="text-base text-gray-700">Devs komunidad is exclusive only for aspiring developers / already developers to help each other grow via exchanging their thoughts and ideas. This community was built and inspired by these inspirational qoutes - "Surround yourself by experienced programmers" and "There's something you know that I don't know and there's something I know that you don't".</p>
